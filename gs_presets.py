...
SETTING_SPECS = {
    ...
    "proposer_radio": SettingSpec("prop", _choice(C.PROPOSER_LABELS), C.DEFAULT_PROPOSER),
...
PRESET_KEYS = {"net": "net_select", "pref": "pref_radio", "noise": "noise_slider", "prop": "proposer_radio", "n": "n_slider", "m": "m_slider", "reach": "reach_slider", "ballung": "ballung_slider", "seed": "seed_input"}
...
# (der Streuungsregler erscheint nur beim Vorliebenmodell mit Streuung und gehört deshalb auch dazu)
KEPT = {key: f"_kept_{key}" for key in ("n_slider", "m_slider", "reach_slider", "ballung_slider", "seed_input", "noise_slider")}
STEPS = {"reach_slider": 5, "ballung_slider": 25, "noise_slider": 5}
